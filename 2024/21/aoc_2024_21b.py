...
def main():
    ...
    direction_robots = [DirectionRobot()]
    for robot_num in range(1, 25):
        direction_robots.append(DirectionRobot(direction_robots[-1]))
    keypad_robot = KeypadRobot(direction_robots[-1])

    answer = 0
    for line in lines:
        this_cost = keypad_robot.key_string_cost('A' + line)
