...
def main():
    fname = 'input.txt'; max_grid = 70; num_to_remove = 1024
    fname = 'test.txt'; max_grid = 6; num_to_remove = 12
    ...
    answer = find_dist((max_grid, max_grid), nodes)
