...
class Module:
    ...
    def __repr__(self):
        return f'{self.module_type}, name={self.name}, state={self.state}, sends to {self.sends_to}'
...
class Conjunction(Module):
    ...
    def __repr__(self):
        return super().__repr__() + f', recieves from {list(self.state.keys())}'
...
high_count = Message.high_count
low_count = Message.low_count
print(f'{high_count=}  {low_count=}  product = {high_count * low_count}')